...
public class MoveMaker {
	...
	private void initMap(){
		...
		map.put(new Candy().getKey() + new Fruit().getKey(), new FruitMove(grid));
		...
		map.put(new HorizontalStripedCandy().getKey() + new Fruit().getKey(), new FruitMove(grid));
		...
		map.put(new VerticalStripedCandy().getKey() + new Fruit().getKey(), new FruitMove(grid));
		...
		map.put(new WrappedCandy().getKey() + new Fruit().getKey(), new FruitMove(grid));
		...
		map.put(new Fruit().getKey() + new Candy().getKey(), new FruitMove(grid));
		map.put(new Fruit().getKey() + new HorizontalStripedCandy().getKey(), new FruitMove(grid));
		map.put(new Fruit().getKey() + new VerticalStripedCandy().getKey(), new FruitMove(grid));
		map.put(new Fruit().getKey() + new WrappedCandy().getKey(), new FruitMove(grid));
		map.put(new Fruit().getKey() + new Bomb().getKey(), new FruitMove(grid));
		map.put(new Fruit().getKey() + new Fruit().getKey(), new FruitMove(grid));
	}
	...
	public Move getMove(int i1, int j1, int i2, int j2) {
		...
		// System.out.println(grid.get(i1, j1).getKey() + grid.get(i2, j2).getKey());
		return move;
	}
